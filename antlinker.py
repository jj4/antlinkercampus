...
class antlinker(object):
    ...
    def upload_list(self, task_code, template_id):
        ...
        data = {
            ...
            "Method": "POST",
            "Body": "{\"Field\":[{\"FieldCode\":\"disabled\",\"Content\":\"自动化学院\"},{\"FieldCode\":\"disabled\",\"Content\":\"2018206931\"},{\"FieldCode\":\"disabled\",\"Content\":\"管政\"},{\"FieldCode\":\"\",\"Content\":\"< 37.3℃\"},{\"FieldCode\":\"\",\"Content\":\"< 37.3℃\"},{\"FieldCode\":\"\",\"Content\":\"< 37.3℃\"},{\"FieldCode\":\"\",\"Content\":\"校外\"},{\"FieldCode\":\"\",\"Content\":\"370782\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"},{\"FieldCode\":\"\",\"Content\":\"否\"}],\"TaskCode\":\"%s\",\"TemplateId\":\"%s\"}" % (task_code, template_id)
        }
        upload = self.s.post(url, headers=self.headers, data=json.dumps(data).encode('utf-8'))
        response = json.loads(upload.text)
        try:
